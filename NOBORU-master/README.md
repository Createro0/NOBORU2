...
## NOBORU2 Updates (v2.0+)
* **Dual Parser Loading System**: Automatic loading from both built-in parsers (`app0:assets/parsers/`) and user-installed parsers (`ux0:data/noboru/parsers/`)
* **nhentai Parser**: New built-in parser for nhentai.to manga site
* **Enhanced Parser Management**: Better error handling and logging for parser loading
